...
if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['mail']) && isset($_POST['add'])){
    ...
    try {
        ...
        //Recipients
        $mail->CharSet = 'UTF-8';
        $mail->setFrom('quantri.vietproshop@gmail.com', 'Vietpro Mobile Shop');	// Gửi mail tới Mail Server quantri.vietproshop@gmail.com tên người dùng nhận được
        $mail->addAddress($email); // Gửi mail tới mail người nhận addAddress(biến mail người nhận)
        ...
        $mail->Body = $str_body;  //Body = nội dung mail
...
echo '<div class="alert alert-danger mt-3" style="font-size: 18px">Giỏ hàng của bạn hiện tại không có sản phẩm nào !</div>';
}
?>